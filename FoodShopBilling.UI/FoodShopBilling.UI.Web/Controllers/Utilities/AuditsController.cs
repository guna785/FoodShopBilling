...
namespace FoodShopBilling.UI.Web.Controllers.Utilities
{
    ...
    public class AuditsController : ControllerBase
    {
        ...
        {
            FoodShopBilling.Shared.Wrapper.IResult<string> data = await _auditService.ExportToExcelAsync(_currentUserService.UserName, searchString, searchInOldValues, searchInNewValues);
            return Ok(data);
        }
    }
}
