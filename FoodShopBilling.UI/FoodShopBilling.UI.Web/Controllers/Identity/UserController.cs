...
namespace FoodShopBilling.UI.Web.Controllers.Identity
{
    ...
    public class UserController : ControllerBase
    {
        ...
        {
            FoodShopBilling.Shared.Wrapper.Result<List<FoodShopBilling.Utilities.Responses.Identity.UserResponse>> users = await _userService.GetAllAsync();
            return Ok(users);
        }
        ...
        {
            FoodShopBilling.Shared.Wrapper.IResult<FoodShopBilling.Utilities.Responses.Identity.UserResponse> user = await _userService.GetAsync(id);
            return Ok(user);
        }
        ...
        /// <returns>Status 200 OK</returns>
        //[Authorize(Policy = Permissions.Users.View)]
        [HttpGet("ReleaseDevice/{id}")]
        public async Task<IActionResult> ReleaseDeviceById(string id)
        {
            FoodShopBilling.Shared.Wrapper.IResult<string> user = await _userService.ReleaseDevice(id);
            return Ok(user);
        }
        ...
        {
            FoodShopBilling.Shared.Wrapper.IResult<FoodShopBilling.Utilities.Responses.Identity.UserRolesResponse> userRoles = await _userService.GetRolesAsync(id);
            return Ok(userRoles);
        }
